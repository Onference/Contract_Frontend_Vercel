                        ...
                        <table style={tableStyle}>
                            <thead>
                                <tr>
                                    ...
                                    <th style={tableHeaderStyle}>Association</th>
                                    ...
                                    <th style={tableHeaderStyle}>Content Availability Duration</th>
                                    <th style={tableHeaderStyle}>Contract Type</th>
                                    <th style={tableHeaderStyle}>Access Type</th>
                                    <th style={tableHeaderStyle}>Format</th>
                                    <th style={tableHeaderStyle}>Content Placement</th>
                                    <th style={tableHeaderStyle}>Honorarium</th>
                                    <th style={tableHeaderStyle}>Ticket Price</th>
                                    <th style={tableHeaderStyle}>Onference Share</th>
                                    <th style={tableHeaderStyle}>Organiser Share</th>
                                    <th style={tableHeaderStyle}>Program/Series/IP Name</th>
                                    <th style={tableHeaderStyle}>Program Date</th>
                                    <th style={tableHeaderStyle}>Episode Title</th>
                                    <th style={tableHeaderStyle}>Number of Episodes/Sessions</th>
                                    ...
                                    <th style={tableHeaderStyle}>Additional Terms</th>
                                </tr>
                            </thead>
                            <tbody>
                                {documents.map((doc, index) => {
                                    return (
                                        <tr key={doc._id || index} style={tableRowStyle}>
                                            ...
                                            <td style={tableCellStyle}>{doc.association}</td>
                                            ...
                                            <td style={tableCellStyle}>{doc.contentAvailabilityDuration}</td>
                                            <td style={tableCellStyle}>{doc.contractType}</td>

                                            <td style={tableCellStyle}>{doc.accessType}</td>
                                            <td style={tableCellStyle}>{doc.format}</td>
                                            <td style={tableCellStyle}>{doc.contentPlacement}</td>

                                            <td style={tableCellStyle}>{doc.honorarium}</td>
                                            <td style={tableCellStyle}>{doc.ticketPrice}</td>
                                            <td style={tableCellStyle}>{doc.onferenceShare}</td>
                                            <td style={tableCellStyle}>{doc.organiserShare}</td>
                                            <td style={tableCellStyle}>{doc.programName}</td>
                                            <td style={tableCellStyle}>{doc.programDate}</td>
                                            ...
                                            <td style={tableCellStyle}>{doc.additionalTerms}</td>
                                        </tr>
                                    );
                                })}
                            </tbody>
